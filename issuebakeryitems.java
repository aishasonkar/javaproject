...
public class issuebakeryitems extends JFrame implements ActionListener
{
	...
	public issuebakeryitems(String orno,String code)
	{
		//this();
		...
		tcode=new JTextField(20);
                 tcode.setBounds(340,120,270,45);
                 add(tcode);
		 tcode.setText(""+code);
		 t1=new JTextField();
		...
		void getdetails()
		{
			...
			{	
				...
				String query="select * from tblbakeryitems where bicode="+code;
				ResultSet rs=stmt.executeQuery(query);
				
				while(rs.next())
				{
					
					t1.setText(""+rs.getString("biname"));
					t2.setText(""+rs.getInt("birate"));
					ImageIcon i2=new ImageIcon(""+rs.getString("bipic"));
					l.setIcon(i2);
		...
		public void actionPerformed(ActionEvent ae)
		{
				...
				{	
					...
					String query1="insert into issuebakeryitems(orderno,bicode,biname,birate,biqty,trate)values ("+orno+","+code+",'"+t1.getText()+"',"+t2.getText()+","+t4.getText()+","+t5.getText()+")"; 
				...
				{	
					...
					{
							issuebakeryitembill e=new issuebakeryitembill(orno);
				...
				{
					new bakeryitems("3001");
				}		
				
		}
		public static void main(String args[])
		{
		issuebakeryitems c = new issuebakeryitems("5001","3001");
		c.setSize(800,800);
		c.setVisible(true);
