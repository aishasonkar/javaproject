...
public class ordern extends JFrame implements ActionListener
{
	...
	public ordern()
	{
		...
		getIcode();	
			...
			{	
				...
				String query="select orderno from issuebakeryitems";
