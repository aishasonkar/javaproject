...
public class issueshake extends JFrame implements ActionListener
{
	...
	public issueshake(String orno,String code)
	{
		//this();
		setLayout(null);
		this.orno=orno;
		...
		tcode=new JTextField(20);
                 tcode.setBounds(340,120,270,35);
                 add(tcode);
		 tcode.setText(""+code);
		 t1=new JTextField();
		...
		void getdetails()
		{
			...
			{	
				...
				String query="select * from tblshakes where scode="+code;
				...
				while(rs.next())
				{
					...
					t2.setText(""+rs.getInt("srate"));
					ImageIcon i2=new ImageIcon(""+rs.getString("spic"));
					l.setIcon(i2);
		...
		public void actionPerformed(ActionEvent ae)
		{
				...
				{	
					...
					String query1="insert into shakeissue(orderno,scode,sname,srate,sqty,trate) values ("+orno+","+code+",'"+t1.getText()+"',"+t2.getText()+","+t4.getText()+","+t5.getText()+")"; 
				...
				{	
					...
					{
							shakebill e=new shakebill(orno);
		...
		{
		issueshake c = new issueshake("5001","1001");
		c.setSize(800,800);
		c.setVisible(true);
