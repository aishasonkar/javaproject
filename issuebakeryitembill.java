...
public class issuebakeryitembill extends JFrame implements ActionListener
{
...
String head[ ]={"orderno","biode","biname","birate","biqty","trate"};
JButton b4;
...
public issuebakeryitembill(String ono)
{
  	       ...
  	       try
  	            {
  	          	 ...
  	          	 String query="select * from issuebakeryitems where orderno="+ono;
...
public static void main(String args[])
{
		...
		issuebakeryitembill e=new issuebakeryitembill("5001");
