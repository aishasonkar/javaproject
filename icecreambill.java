...
public class icecreambill extends JFrame implements ActionListener
{
...
String head[ ]={"orderno","icode","iname","irate","iqty","trate"};
JButton b4;
...
public icecreambill(String ono)
{
  	       ...
  	       try
  	            {
  	          	 ...
  	          	 String query="select * from icecreamissue where orderno="+ono;
...
public static void main(String args[])
{
		...
		icecreambill e=new icecreambill("5001");
